...
declare namespace compression {
    var getPluginAPI: (plugins: readonly Plugin<any>[]) => CompressionPluginAPI;
}

export { type Algorithm, type CompressionOptions, type ViteCompressionPluginConfig, type ViteTarballPluginOptions, compression, compression as default, tarball };
